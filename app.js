document.addEventListener('DOMContentLoaded', () => {
    const conferences = [
        ...
        {"id": 7, "titre": "IIIe Congrès international de l'ÉDIQ", "date": "2026-06-02", "dateFin": "2026-06-04", "lieu": "Université Laval", "categorie": "Sciences Sociales", "description": "Immigrer, vivre et se (re)construire.", "lien": "https://www.ediq.ulaval.ca"},
        {"id": 16, "titre": "Mois de l'innovation publique", "date": "2026-06-01", "dateFin": "2026-06-30", "lieu": "Québec / Montréal", "categorie": "Gouvernance collaborative & concertation", "description": "Innovation dans les services publics.", "lien": "https://www.quebec.ca"},
        {"id": 8, "titre": "Colloque international du CELAT 2026", "date": "2026-06-15", "dateFin": "2026-06-17", "lieu": "Montréal / Québec", "categorie": "Sciences Sociales", "description": "Médiation interculturelle.", "lien": "https://celat.ca"},
    ...
    // -- LE TRI (Plus proche en 1er) --
    conferences.sort((a,b) => new Date(a.date) - new Date(b.date));
    ...
    function filterByCategory(category) {
        let f = (category === 'Tous') ? conferences : conferences.filter(c => c.categorie === category);
        renderConferences(f);
    }
        ...
        list.forEach(conf => {
            ...
            tile.innerHTML = `
                ...
                <div class="tile-content">
                    ...
                    <div class="tile-actions"><a href="${conf.lien}" class="tile-link" target="_blank">Site de l'événement</a></div>
                </div>
            `;
    ...
    function formatDate(s) { return new Date(s).toLocaleDateString('fr-FR', { day: 'numeric', month: 'long', year: 'numeric' }); }
